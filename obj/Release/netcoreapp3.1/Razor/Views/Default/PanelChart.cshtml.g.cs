#pragma checksum "C:\Users\Atul\OneDrive\Documents\Projects\RKBoss.net\RK\RK\Views\Default\PanelChart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c3ef346991bbcdcf824e9bc1d9175503804750a4"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c3ef346991bbcdcf824e9bc1d9175503804750a4", @"/Views/Default/PanelChart.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c3ef346991bbcdcf824e9bc1d9175503804750a45375", async() => {
                WriteLiteral(@"
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "c3ef346991bbcdcf824e9bc1d9175503804750a47167", async() => {
                WriteLiteral("\r\n    <!--Logo Row-->\r\n    <div class=\"container box-border\">\r\n        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "c3ef346991bbcdcf824e9bc1d9175503804750a47500", async() => {
                }
                );
...
#line 51 "C:\Users\Atul\OneDrive\Documents\Projects\RKBoss.net\RK\RK\Views\Default\PanelChart.cshtml"
                                    ...
                                    //    firstRow = "<tr>";
                                        //    for (int i = 0; i < 5; i++)
                                        //    {
                                        //        firstRow = firstRow + "<td colspan='3' class='table-seperator'>" + seq[startIndex] + "  " + (i + 1) + "</td>";
                                        //    }
                                        ...
                                        //if ((startIndex < 3 && perRowCount % 10 == 0 && perRowCount != 0) || (startIndex < 3 && perRowCount > 10))
                                            //{
                                            //    startIndex++;
                                            //}
                                            //if (startIndex >= 15 && startIndex < 25)
                                            //{
                                            //    startIndex--;
                                            //}
                                            ...
                                            for (int i = z; i < (z + 5); i++)
                                            {
                                                temp = temp + "<td colspan='3' class='table-seperator allTds'  style='color:blue'>" + seq[startIndex] + "  " + (i + 1) + "</td>";
                                            }
                                        ...
                                        //    //for (int i = 0; i < 5; i++)
                                        //    //{
                                        //    //    temp = temp + "<td colspan='3' class='table-seperator'>" + seq[1] + "  " + (i + 1) + "</td>";
                                        //    //}
                                        //    firstRow = perRowCount != 0 ? firstRow + "</tr>" + "<tr>" : firstRow + "<tr>";
                                        //    starKalyan = 0;
                                        //}
...
#line hidden
                WriteLiteral("                                ");
#line 273 "C:\Users\Atul\OneDrive\Documents\Projects\RKBoss.net\RK\RK\Views\Default\PanelChart.cshtml"
...
#line hidden
                WriteLiteral("\r\n\r\n\r\n");
                WriteLiteral("\r\n\r\n                            </tbody>\r\n                        </table>\r\n");
#line 521 "C:\Users\Atul\OneDrive\Documents\Projects\RKBoss.net\RK\RK\Views\Default\PanelChart.cshtml"
                    }
